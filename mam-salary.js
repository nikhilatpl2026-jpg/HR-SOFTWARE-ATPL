...
function loadRootFix(done){load('mam-v5-runtime-root-fix-v1.js?v=20260915-rootfix1',done)}
...
function v5(){loadRootFix(function(){loadLokeshLock(function(){load('mam-compliance-rules-india-v1.js?v=20260914-rules1a',function(ruleErr){
