...
function loadScopedV5(done){load('mam-compliance-v5-scoped-loader-v1.js?v=20260916-importflex2',function(err){if(err||typeof window.ATPLLoadMamComplianceV5ScopedV1!=='function')return done(err||new Error('Scoped V5 loader unavailable'));window.ATPLLoadMamComplianceV5ScopedV1(done)})}
