/* ATPL Mam Salary bootstrap — NEXT engine, isolated generator fallback, then stable legacy fallback. */
(function(){'use strict';
...
load('mam-salary-next-v3.js?v=20260914-next3a',function(err){
  var old=document.getElementById('atplUpgradeLoadError');if(old)old.remove();
  if(err)generatorFallback();
});
})();
