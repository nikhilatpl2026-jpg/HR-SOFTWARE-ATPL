/* ATPL Mam Salary bootstrap — isolated generator with the stable legacy fallback. */
(function(){'use strict';
...
load('mam-salary-generator.js?v=20260914-generator1',function(err){
  var old=document.getElementById('atplUpgradeLoadError');if(old)old.remove();
  if(err){console.error(err);load('mam-salary-v2-legacy.js?v=20260911-stable1')}
});
})();
