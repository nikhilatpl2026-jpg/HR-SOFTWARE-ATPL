...
function loadScopedV3(done){load('mam-compliance-v5-scoped-loader-v2.js?v=20260916-calc-source4',function(v2scriptErr){if(v2scriptErr)return loadScopedV1(done);load('mam-compliance-v5-source-merge-v3.js?v=20260916-source-merge4',function(v3scriptErr){if(v3scriptErr||typeof window.ATPLLoadMamComplianceV5SourceMergeV3!=='function')return runScopedV2(done);window.ATPLLoadMamComplianceV5SourceMergeV3(function(v3err){if(v3err&&!window.__MAM_COMPLIANCE_V5__)return runScopedV2(done);done(v3err)})})})}
