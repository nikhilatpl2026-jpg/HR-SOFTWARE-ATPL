...
function loadScopedV2(done){load('mam-compliance-v5-scoped-loader-v2.js?v=20260916-calc-source2',function(err){if(err||typeof window.ATPLLoadMamComplianceV5ScopedV2!=='function')return loadScopedV1(done);window.ATPLLoadMamComplianceV5ScopedV2(function(v2err){if(v2err&&!window.__MAM_COMPLIANCE_V5__)return loadScopedV1(done);done(v2err)})})}
