/* Tiny lazy loader for Arora ERP AI PRO V7. No ERP data work runs at startup. */
(function(){
'use strict';
...
function openAI(q){
  ...
  if(window.AroraAIV7&&typeof window.AroraAIV7.open==='function'){window.AroraAIV7.open();return;}
  if(loading)return;
  loading=new Promise(function(resolve,reject){
    var s=document.createElement('script');s.src='hr-ai-pro-v7.js?v=20260912-7';s.async=true;
    s.onload=function(){
      var tries=0;
      (function waitReady(){
        if(window.AroraAIV7&&typeof window.AroraAIV7.open==='function'){resolve();window.AroraAIV7.open();return;}
        if(++tries>80){loading=null;reject(new Error('AI V7 init timeout'));alert('AI Assistant load nahi hua. Page refresh karke dobara try karo.');return;}
